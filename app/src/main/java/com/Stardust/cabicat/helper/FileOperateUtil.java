    ...
    public static void openFileByPath(Context context, String path) {
        ...
        try {
            ...
            if (context.getPackageManager().resolveActivity(intent, PackageManager.MATCH_DEFAULT_ONLY) != null) {
                ...
                Toast.makeText(context, "this program has not found ", Toast.LENGTH_SHORT).show();
            }

        } catch (Exception e) {
            Toast.makeText(context, "you can not open this type of file", Toast.LENGTH_SHORT).show();
            e.printStackTrace();
        }
    }
